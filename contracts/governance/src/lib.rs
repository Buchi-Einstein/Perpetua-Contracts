...
pub enum GovernanceError {
    ...
    InvalidCalldata = 20,
    /// Emergency guardian configuration exceeds the supported size.
    TooManyEmergencyGuardians = 21,
    /// Duplicate emergency guardian address.
    DuplicateEmergencyGuardian = 22,
}
...
impl FluxoraGovernance {
    ...
    pub fn init(
        ...
        env.storage()
            .instance()
            .set(&DataKey::EmergencyGuardians, &Vec::new(&env));
        env.storage()
            .instance()
